		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] PERINTAH INI KHUSUS USER *MOD OCHO BOT*',
					...
					userB: `──「 DAFTAR 」──\nHalo Kak !\nMaaf Kak Kamu belum Terdaftar Dalam Data BaseKami Untuk Daftar Dengan ocho bot dengam cara, \n\nCommand : ${prefix}daftar nama|umur\nContoh : ${prefix}daftar ochobot|17\n\n──「 OCHOBOT 」──`,
			...
			const ownerNumber = ["6281803522862@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"6281803522862@s.whatsapp.net"]
			const adminbotnumber = ["6281803522862@s.whatsapp.net"]
			const frendsowner = ["6281803522862@s.whatsapp.net"]
			const premium = ["6281803522862@s.whatsapp.net"]
